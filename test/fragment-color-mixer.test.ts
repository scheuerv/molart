...
describe("FragmentColorMixer tests", function () {
    ...
    it('tests if mixing inculeds all fragments', async () => {
        ...
        expect(mixFragmentColors(trackFragments1)[0].color).to.not.deep.equals(mixFragmentColors(trackFragments2)[0].color);
    });
});