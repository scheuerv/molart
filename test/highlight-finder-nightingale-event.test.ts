...
describe("HighlightFinderNightingaleEvent tests", function () {
    ...
    describe("calculate test", function () {
        ...
        it("pdbId 2dnc test", async () => {
            ...
            {
                uniprotStart: 57, uniprotEnd: 141, fragmentMappings: [
                    { pdbStart: 8, pdbEnd: 92, from: 57, to: 141 }]
            }
    ...
    describe("getStructurePositionOfFirstResidueInFragment test", function () {
        it("one fragment, position inside", async () => {
            ...
            expect(instance.getStructurePositionOfFirstResidueInFragment(55, mapping)).to.equals(50);
        });
        ...
        it("two fragments, position in first", async () => {
            ...
            expect(instance.getStructurePositionOfFirstResidueInFragment(10, mapping)).to.equal(372);
        });
        ...
        it("two fragments, position in second", async () => {
            ...
            expect(instance.getStructurePositionOfFirstResidueInFragment(30, mapping)).to.equal(382);
        });
    });
});